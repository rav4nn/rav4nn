...
`Python` `ChromaDB` `RAGAS` `sentence-transformers` `FastAPI`
...
`RAG` `FAISS` `ChromaDB` `sentence-transformers` `RAGAS`
`LLM APIs (Anthropic / OpenAI / Gemini / DeepSeek)`

---

## open to

AI engineering roles at early-stage startups. Small teams, real products, fast iteration.
